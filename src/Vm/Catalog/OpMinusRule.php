...
/**
 * @extends AbstractVmRule<OpCode::Minus>
 */
readonly class OpMinusRule extends AbstractVmRule
{
    protected function execute(VmContext $context, OpCode $opCode): void
    {
        ...
        if ($operand instanceof IntSysObject) {
            $context->stack->push(new IntSysObject((string)(-$operand->nativeValue())));
