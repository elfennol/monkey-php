...
/**
 * @extends AbstractVmRule<OpCode::Div>
 */
readonly class OpDivRule extends AbstractVmRule
{
    protected function execute(VmContext $context, OpCode $opCode): void
    {
        ...
        if ($right instanceof IntSysObject && $left instanceof IntSysObject) {
            $context->stack->push(new IntSysObject((string)(intdiv($left->nativeValue(), $right->nativeValue()))));
