...
/**
 * @extends AbstractVmRule<OpCode::Add>
 */
readonly class OpAddRule extends AbstractVmRule
{
    protected function execute(VmContext $context, OpCode $opCode): void
    {
        ...
        if ($right instanceof StringSysObject && $left instanceof StringSysObject) {
            $context->stack->push(new StringSysObject($left->nativeValue() . $right->nativeValue()));
