...
readonly class PrefixModifierRule implements ModifierRuleInterface
{
    public function apply(Modifier $modifier, NodeInterface $node, Closure $action): ModifierRuleResult
    {
        ...
        if (!$operand instanceof ExprNodeInterface) {
            throw new EvaluatorException(
                ...
                'Macro:: operand must be a expression for a prefix expression.'
            );
        }
    ...
    /**
     * @phpstan-assert-if-true PrefixOpNode $node
     */
